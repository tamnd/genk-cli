...
Most of these come down to network reality or how genk serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

genk rate-limits like any public site. genk already paces
...
Where a surface is gated, genk reads a cookie or token you supply
...
`genk`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what genk actually did
